...
if(isset($_POST['event_categorySpecial'])) {
    ...
    $event_judge = $_POST['event_judgeSpecial'];
...
';
                    ...
                    if (!empty($contestantsByCategoryFemale)) {
                        ...
                        if ($conGeneral == 1) {  // Use double equal sign for comparison
                            $summary .= '
                                <h3 class="fm-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
                                <h6 class="fm-hd text-muted" align="center">General Summary</h6>
                            ';
                        } else {
                            $summary .= '
                                <h3 class="fm-hd mt-5 text-success" align="center">Special Event</h3>
...
';
                    ...
                    if ($conGeneral == 1) {  // Use double equal sign for comparison
                        $summary .= '
                            <h3 class="m-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
...
';
                    if (!empty($contestantsByCategoryMaleFemale)){
                        ...
                        if ($conGeneral == 1) {  // Use double equal sign for comparison
                            $summary .= '
                                <h3 class="mf-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
...
';                  
                    if (!empty($contestantsByCategoryGay)){
                        ...
                        if ($conGeneral == 1) {  // Use double equal sign for comparison
                            $summary .= '
                                <h3 class="gy-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
...
';
                    if (!empty($contestantsByCategoryLesbian)){
                        ...
                        if ($conGeneral == 1) {  // Use double equal sign for comparison
                            $summary .= '
                                <h3 class="ls-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
...
';
                    if (!empty($contestantsByCategorygayLesbian)){
                        //=============================================== LGBTQ Gay/Female table =================================================================================================
                                
                        //table for category gay

                        if ($conGeneral == 1) {  // Use double equal sign for comparison
                            $summary .= '
                                <h3 class="gyls-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
                                <h6 class="gyls-hd mt-5 text-muted" align="center">General Summary</h6>
                            ';
                        } else {
                            $summary .= '
                                <h3 class="gyls-hd mt-5 fw-bold text-danger" align="center">Special Event</h3>
                                <h6 class="gyls-hd mt-4 text-muted" align="center">Gay/Female Category Summary </h6>
                            ';
                        }
