...
INSERT INTO `contestant` (id, code, sequence, name, is_finalist, category_code, gender) VALUES ('1', '001', '1', 'ANDREA', '1', 'FE', 'F');

INSERT INTO `contestant` (id, code, sequence, name, is_finalist, category_code, gender) VALUES ('2', '002', '2', 'LEA', '1', 'FE', 'F');

INSERT INTO `contestant` (id, code, sequence, name, is_finalist, category_code, gender) VALUES ('3', '003', '3', 'GERLIE', '0', 'FE', 'F');

INSERT INTO `contestant` (id, code, sequence, name, is_finalist, category_code, gender) VALUES ('7', '004', '4', 'Kratos', '0', 'MA', 'M');

INSERT INTO `contestant` (id, code, sequence, name, is_finalist, category_code, gender) VALUES ('8', '005', '5', 'Loki', '0', 'MA', 'M');

INSERT INTO `contestant` (id, code, sequence, name, is_finalist, category_code, gender) VALUES ('9', '006', '6', 'Thor', '1', 'B', 'M');
...
INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('722', '000001', 'PR', '001', '000003', '001', '001', '10', 'FE', '2025-02-10 21:05:03', '2025-08-26 21:08:27');

INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('723', '000002', 'PR', '001', '000003', '002', '001', '10', 'FE', '2025-02-10 21:05:03', '2025-08-26 21:08:27');

INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('724', '000003', 'PR', '001', '000003', '003', '001', '10', 'FE', '2025-02-10 21:05:03', '2025-08-26 21:08:27');

INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('725', '000004', 'PR', '001', '000003', '004', '001', '10', 'FE', '2025-02-10 21:05:03', '2025-08-26 21:08:27');
...
INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('841', '000120', 'PR', '001', '000006', '001', '006', '8', 'B', '2025-08-26 22:25:31', '2025-08-26 22:25:31');

INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('842', '000121', 'PR', '001', '000006', '002', '006', '8', 'B', '2025-08-26 22:25:31', '2025-08-26 22:25:31');

INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('843', '000122', 'PR', '001', '000006', '003', '006', '8', 'B', '2025-08-26 22:25:31', '2025-08-26 22:25:31');

INSERT INTO `event_score` (id, code, event_type_code, event_code, judge_code, criteria_code, contestant_code, score, category_code, added_timestamp, updated_timestamp) VALUES ('844', '000123', 'PR', '001', '000006', '004', '006', '8', 'B', '2025-08-26 22:25:31', '2025-08-26 22:25:31');
...
INSERT INTO `setting` (id, condition_final, pageant_name, isGeneral, logo, cover_photo, weighted_scoring) VALUES ('1', '2', 'MR & MS FRESHMEN 2024_25', '0', 'logo.png', 'pageant-background.png', '0');
...
INSERT INTO `user` (id, code, username, password, name, types, category, is_both, status, added_by, added_timestamp, updated_by, updated_timestamp) VALUES ('5822', '000003', 'j1', 'j1', 'Judge1-NOLI DE CASTRO', 'isJudge', 'FE', '1', '1', '000001', '2024-09-26 08:29:36', '000001', '2025-08-26 20:19:20');

INSERT INTO `user` (id, code, username, password, name, types, category, is_both, status, added_by, added_timestamp, updated_by, updated_timestamp) VALUES ('5823', '000004', 'j2', 'j2', 'Thor Son of Oden', 'isJudge', 'FE', '1', '1', '000001', '2024-12-07 22:02:35', '000001', '2025-02-10 20:01:57');

INSERT INTO `user` (id, code, username, password, name, types, category, is_both, status, added_by, added_timestamp, updated_by, updated_timestamp) VALUES ('5824', '000005', 'j3', 'j3', 'Kratos', 'isJudge', 'LGBTQ-LES', '1', '1', '000001', '2024-12-07 22:03:03', '000001', '2025-02-10 20:02:02');

INSERT INTO `user` (id, code, username, password, name, types, category, is_both, status, added_by, added_timestamp, updated_by, updated_timestamp) VALUES ('5829', '000006', 'j4', 'j4', 'Pak', 'isJudge', 'B', '1', '1', '000001', '2025-08-26 20:19:38', '', '');
